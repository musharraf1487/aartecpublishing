      ...
      <div className="max-w-7xl mx-auto">
        <div className="bg-white rounded-3xl p-12 lg:p-20 shadow-xl border border-slate-100 relative overflow-hidden">
          ...
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-aartec-charcoal serif mb-4">
              Qualification Protocol
            </h2>
            <p className="text-aartec-teal font-bold uppercase tracking-[0.2em] text-[10px]">
              Is AARTEC the right partner for you?
            </p>
          </div>
          ...
          <div className="grid gap-6">
            {[
              ...
              <div
                key={i}
                className="flex items-start bg-white p-6 rounded-2xl border border-slate-100 hover:border-aartec-amber/50 transition-all shadow-sm"
              >
          ...
          <div className="mt-16 text-center border-t border-slate-50 pt-10">
            <p className="text-slate-400 text-xs italic font-light max-w-sm mx-auto">
              Important: We limit intake to 5 publishing projects per month.
              Quality and velocity are our non-negotiables.
            </p>
          </div>
        </div>
      </div>
