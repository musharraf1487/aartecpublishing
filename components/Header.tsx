    ...
    <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-slate-100 px-6 py-4">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center space-x-8 text-sm font-semibold text-slate-600">
          <a href="#solution" className="hover:text-aartec-teal transition-colors">Our Ecosystem</a>
          <a href="#proof" className="hover:text-aartec-teal transition-colors">Results</a>
          <a href="#affiliate" className="hover:text-aartec-teal transition-colors text-slate-400">Partners</a>
        </nav>
